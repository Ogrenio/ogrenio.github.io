                ...
                <nav className="shadow-md md:shadow-none bg-white md:bg-transparent mx-auto flex justify-between items-center py-2 px-5 md:py-5">
                    ...
                    <ul className="hidden md:flex space-x-6">
                        ...
                        <li>
                            <Link 
                                href="/login" 
                                className="text-white bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 px-8 py-3 rounded-full transition-all duration-300 hover:shadow-[0_0_25px_rgba(251,191,36,0.8)]"
                            >
                                Giriş Yap
                            </Link>
                        </li>
