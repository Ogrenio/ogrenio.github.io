    ...
    return (
        <div className={clsx("w-full max-w-sm mx-auto bg-white rounded-xl border border-gray-200 lg:max-w-full", { "shadow-lg": highlight })}>
                    ...
                    <span className={clsx({ "text-secondary": highlight })}>
                        {typeof price === 'number' ? (
                            <>
                                <span>₺{price}</span>
                                {name === 'Profesyonel' && (
                                    <span className="text-lg font-normal text-gray-400 line-through ml-2">₺100</span>
                                )}
                            </>
                        ) : price}
                    </span>
                    {typeof price === 'number' && <span className="text-lg font-normal text-gray-600">/aylık</span>}
                </p>
            ...
            <div className="p-6 mt-1">
                <p className="font-bold mb-5">Özellikler</p>
